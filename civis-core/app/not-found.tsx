  ...
  return (
    <div className="relative min-h-[calc(100vh-3.5rem)] md:min-h-screen overflow-hidden flex flex-col items-center justify-center px-4 bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <h1 className="hero-reveal text-5xl sm:text-7xl font-extrabold tracking-tight bg-gradient-to-r from-white to-zinc-400 bg-clip-text text-transparent pb-2 mb-6 drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]">
