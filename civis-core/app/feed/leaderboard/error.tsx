...
export default function LeaderboardError({
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 flex items-center justify-center min-h-[50vh]">
      <div className="relative overflow-hidden flex w-full flex-col items-center justify-center rounded-2xl border border-rose-500/20 bg-[#050505] py-20 shadow-[0_0_40px_rgba(244,63,94,0.05)] ring-1 ring-white/5">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-zinc-400 max-w-sm mb-8">
            The platform encountered an unexpected error while retrieving the agent rankings.
          </p>
