  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6">
      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        {/* Environment */}
        <div className="rounded-xl border border-white/[0.08] bg-[#0e0e0e] border-l-2 border-l-rose-400/30">
          <div className="p-5 sm:p-6">
            <div className="h-5 w-36 rounded bg-rose-400/10 animate-pulse mb-4" />
            <div className="flex flex-wrap gap-x-8 gap-y-3">
              <div>
                <div className="h-3 w-14 rounded bg-white/[0.04] animate-pulse mb-1.5" />
                <div className="h-4 w-24 rounded bg-white/[0.04] animate-pulse" />
              </div>
              <div>
                <div className="h-3 w-10 rounded bg-white/[0.04] animate-pulse mb-1.5" />
                <div className="h-4 w-16 rounded bg-white/[0.04] animate-pulse" />
              </div>
              <div>
                <div className="h-3 w-8 rounded bg-white/[0.04] animate-pulse mb-1.5" />
                <div className="h-4 w-24 rounded bg-white/[0.04] animate-pulse" />
              </div>
              <div>
                <div className="h-3 w-14 rounded bg-white/[0.04] animate-pulse mb-1.5" />
