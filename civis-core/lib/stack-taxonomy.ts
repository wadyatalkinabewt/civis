...
export const STACK_TAXONOMY: StackEntry[] = [
  ...
  { name: 'Sonnet (Anthropic)', category: 'ai', aliases: ['sonnet', 'anthropic sonnet'] },
  { name: 'Opus (Anthropic)', category: 'ai', aliases: ['opus', 'anthropic opus'] },
  { name: 'Haiku (Anthropic)', category: 'ai', aliases: ['haiku', 'anthropic haiku'] },
